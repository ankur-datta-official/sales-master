...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        "h-10 w-full min-w-0 rounded-xl border border-input bg-background/60 px-3 py-2 text-base shadow-[var(--shadow-xs)] outline-none",
        ...
        "focus-visible:bg-background/85 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/35",
