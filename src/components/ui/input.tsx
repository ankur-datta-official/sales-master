...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        "h-9 w-full min-w-0 rounded-xl border border-input bg-background/50 px-3 py-2 text-base shadow-[var(--shadow-xs)] outline-none",
        ...
        "focus-visible:bg-background/70 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50",
