...
import { CreateSalesTargetForm } from "@/modules/sales-targets/components/create-sales-target-form";
  ...
  if (!orgId || !profile?.id) {
    return (
      <div className="space-y-2">
        <h1 className="text-2xl font-semibold tracking-tight">New sales target</h1>
