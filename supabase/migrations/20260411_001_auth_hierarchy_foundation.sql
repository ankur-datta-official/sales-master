...
create table if not exists public.profiles (
  ...
  constraint profiles_status_chk check (status in ('invited', 'active', 'inactive', 'suspended'))
);
...
-- Status filters for admin screens and user lifecycle queries
